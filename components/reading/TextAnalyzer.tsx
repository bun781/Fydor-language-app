...
export function TextAnalyzer() {
  ...
  return (
    <section className="reading-analyzer">
      <div className="reading-analyzer-toolbar">
        <p className="muted">Paste any text to compare it against words, grammar, and chunks from your imported lessons.</p>
