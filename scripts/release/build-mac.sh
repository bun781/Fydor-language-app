#!/usr/bin/env bash
# Builds, ad-hoc signs, and packages the macOS DMG. Set
# FYDOR_MAC_SIGNING_IDENTITY to use a Developer ID identity instead.
# The default path is intentionally unsigned/not notarized. Prints one final line:
#   OK <path-to-dmg>
# or
